...
export class Backend implements backendInterface {
    ...
    async getPublishedContent(): Promise<ValentineContent> {
        if (this.processError) {
            try {
    ...
    async updatePublishedContent(arg0: ValentineContent): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePublishedContent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
